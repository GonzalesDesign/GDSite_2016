...
(function($, Edge, compId){
        ...
        (function(symbolName) {
         	...
         	console.log("February 19, 2015: 16:9 Screen Ratio. Full screen images.");
         	//------------------------( On load, refresh go to the top )------------------------//
         	window.scrollTo(0, 0); //Changed scroll to scrollTo
                ...
                var mS = $(sym.createChildSymbol("mainScreen", "Stage").getSymbolElement());
                        ...
                        tMx.to(mS, 1, {css:{ position:"fixed", x : 0, y : 0}, ease:easeSine}); //------=== WIP  fixed
                ...
                //--------( CREATE MAIN TITLE INSIDE MAIN SCREEN )-------//
		...
		*/
			...
			*/
			...
			tMx.to(sB, 0, {css:{ position:"fixed", x : 0, y : topBackgrndYPos, zIndex : 200}}); 
			//console.log("topBackgrndYPos: " + topBackgrndYPos);

			tMx.to(audioBtn, 1, {css:{ position:"fixed", x : 20, y : topBackgrndYPos-100, zIndex : 150}});
                ...
                var s6 = sym.getSymbol(mS).$("s6");
                       ...
                       // s1Desc.css({"position" : "absolute", "left" : 0 + "px", "top" : -450 + "px"});
                        ...
                        s3.css({"position" : "absolute", "left" : 0 + "px", "top" : 1536 + "px"});
                                ...
                                var darkBG = sym.getSymbol(s3).$("darkBG");
